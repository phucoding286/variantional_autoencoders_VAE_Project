## Đây là một mã triễn khai và huấn luyện mô hình Variantional Autoencoders (VAE) từ đầu, được viết bởi Phú. 💻
...
- ❗ Cách dùng:
  ...
  - Sau đó bạn đóng băng gradient của nó và dùng latent từ encoder của nó để làm input huấn luyện các mô hình như Diffusion hoặc GAN.
